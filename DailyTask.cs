...
namespace BulletJournal
{
    public partial class DailyTask : Form
    {
        ...
        private void saveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (accessMode == JournalTask.EntryMode.edit)
            {
                string updateCommand = "update dailymain " +
                ...
                string delateCommand = "delete from dailydetail " +
                ...
                dbTools.GenericNonQueryAction(delateCommand, deleteParameters);

                string insertCommand = "insert into dailydetail (tasktype, taskdescription, taskisimportant, maintaskforeignkey) values " +
            ...
            else if (accessMode == JournalTask.EntryMode.migrate)
            {
                ...
                {
                    string mainCommand = "insert into dailymain (taskdate) output inserted.taskid values (@taskDate)";
                    ...
                    string detailCommand = "insert into dailydetail (tasktype, taskdescription, taskisimportant, maintaskforeignkey) values " +
                                  "(@tasktype, @taskdescription, @taskisimportant, @foreignkey)";
        ...
        private void GetDailyData(int id)
        {
            ...
            DataTable dailyMainTable = dbTools.GenericQueryAction(mainCommand, mainParameters);
